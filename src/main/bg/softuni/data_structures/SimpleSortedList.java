package main.bg.softuni.data_structures;
...
public class SimpleSortedList<E extends Comparable<E>> implements SimpleOrderedBag<E> {
    ...
    public String joinWith(String joiner) {
        ...
        StringBuilder oitput = new StringBuilder();
        for (E e : this) {
            oitput.append(e);
            oitput.append(joiner);
        }

        oitput.setLength(oitput.length()-joiner.length());
        return oitput.toString();
    }
